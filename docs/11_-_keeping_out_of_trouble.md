...
Flares are regulated under the Japanese explosives and firearms regulations so unless you are using one on the expresway to signal an accident they are illegal unless used without official permission. You'll definitely get in legal trouble if you are caught using one inside, and outside the stadium.

### Stadium Security

Stadium Security is outsourced to private event management companies. A lot of the staff checking tickets, guarding entrances are univeristy students. Don't expect them to be very knowledgeable or flexible. All they can do is to escaalte any issues to their manager. The manager is usually the same at each match and actually works at away matches too as they know the fans and the call leader.

### Collective Punishment 

If you are a member of an indentified as a member of a group e.g. wearing their t-shirt or scarf or responding to a call to gahter at a certain place then if somthing goes wrong and there is trouble then all the group members will incur punishment and you may be banned along with them. Indefinite stadium bans are common even for what would seem to be minor infractions in other countries.   

I think this done for a couple of reasons. Society and the club expect that groups regulate their behavior themselves so all are to blame. The League will punish the club with a fine and since that fine is not recoverable from the group then the group is banned as they are a risk to future loss.

Indefinite bans have been given for crossing the barrier onto the pitch, fireworks, pyro, fighting, verbally abusing the players even holding up the middle finger.
